    ...
    contentItem: Rectangle {
        ...
        ColumnLayout {
            ...
            Label {
                ...
                text: "Cetus " + aboutDialog.version
            ...
            Label {
                ...
                text: "Copyright 2014 by Alexander Rössler<br>"
                      ...
                      + "<br>"
                      + "<a href='https://github.com/strahlex/Cetus'>Cetus</a> is licensed under the <a href='http://www.gnu.org/licenses/agpl-3.0.html'>GNU Affero General Public License, version 3</a>."
